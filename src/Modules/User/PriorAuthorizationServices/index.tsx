...
function PriorAuthorizationServices() {
    ...
    <Grid container justifyContent={"center"} alignItems={"center"}>
      <GridStyled item xs={12}>
        <Stack
          ...
          gap={3}
        >
          <Typography style={{textAlign: "center"}} color={"black"} fontWeight={600} variant={windowWidth < 900 ? "h3" : "h2"}>
            Prior Authorization Services
          </Typography>
          <Typography fontWeight={500} style={{textAlign: "center" , padding : 4}} variant={"body1"}>
